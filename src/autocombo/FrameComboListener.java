...
public class FrameComboListener extends JFrame 
{
	...
	{
		super("Auto Complete ComboBox - Ronald Fadly");
		setResizable(false);
		...
		btnTampilkan.setIcon(new ImageIcon("C:/Java/Workspace/AutoCompleteComboBox/src/Gambar/tampilData.png"));
		...
		btnRefresh.setIcon(new ImageIcon("C:/Java/Workspace/AutoCompleteComboBox/src/Gambar/Refresh.png"));
		...
		lblIco = new JLabel("");
		lblIco.setIcon(new ImageIcon("C:/Java/Workspace/AutoCompleteComboBox/src/Gambar/Pesawat.png"));
		lblIco.setBounds(388, 104, 196, 166);
		contentPane.add(lblIco);
		
		lblBg = new JLabel("");
		lblBg.setIcon(new ImageIcon("C:/Java/Workspace/AutoCompleteComboBox/src/Gambar/AirWallpaper.png"));
